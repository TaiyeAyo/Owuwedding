    ...
    <div className="min-h-screen bg-background">
      ...
      >
        <div className="text-center max-w-3xl mx-auto py-16 px-8 md:px-16">
          ...
          <div className="mt-12 space-y-2 animate-fade-in-up-delay-3">
            ...
            <p className="font-body text-base text-muted-foreground tracking-wider">at 11 o'clock prompt</p>
      ...
      <section className="py-24 px-4 bg-card">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h2 className="font-display text-4xl md:text-5xl text-foreground mb-6">We're Getting Married</h2>
          ...
          <p className="font-body text-lg text-muted-foreground max-w-xl mx-auto leading-relaxed mt-10">
            We would be honoured to have you share in our joy as we begin our journey together as one. Please let us
        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="text-center">
            ...
            <div className="inline-block p-6 bg-card rounded-lg border border-border shadow-sm mb-6">
              <QRCodeSVG value={rsvpUrl} size={180} bgColor="transparent" fgColor="hsl(30, 10%, 20%)" level="M" />
            </div>

            <p className="font-body text-muted-foreground mb-4">Scan the QR code or click below</p>
          ...
          {/* Registry */}
          <div className="text-center">
            <p className="text-primary tracking-[0.3em] uppercase text-sm font-body mb-4">Your Presence is Our Gift</p>
            ...
            <p className="font-body text-muted-foreground max-w-sm mx-auto mb-8 leading-relaxed">
              Your love and presence at our wedding is the greatest gift. However, if you wish to honor us with cash or
              a gift, we have curated a registry below for your convenience. Thank you in advance.
            </p>
      ...
      <section className="py-24 px-4 bg-background">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-primary tracking-[0.3em] uppercase text-sm font-body mb-4">Getting There</p>
          ...
          <p className="font-body text-lg text-muted-foreground max-w-xl mx-auto leading-relaxed mb-8">
            Let us know when you're arriving so we can help coordinate. Plus, check out our upcoming hotel discounts for
            guests.
          </p>
          <Link
            to="/travel"
      ...
      <section className="py-24 px-4 bg-card">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-primary tracking-[0.3em] uppercase text-sm font-body mb-4">Where to Park</p>
          <h2 className="font-display text-4xl md:text-5xl text-foreground mb-6">Reception Parking</h2>
          <div className="gold-divider w-32 mx-auto mb-10" />
          <p className="font-body text-lg text-muted-foreground max-w-xl mx-auto leading-relaxed mb-8">
            Please see the maps of the 2 parking locations. Signs indicating wedding parking will be at the entrance of
            both lots. On weekends, most lots are acceptable places to park on campus.
          </p>
      ...
      <footer className="py-12 px-4 bg-card text-center">
        ...
        <p className="font-display text-2xl text-foreground mb-2">Isabel &amp; Taiye</p>
        <p className="font-body text-muted-foreground tracking-wider text-sm">With love, forever and always</p>
